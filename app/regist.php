		...
		<div class="container p-2 rounded mt-5 shadow w-25 text-center" style="background-color: #E2BFF6;">
			...
			<form action="regist_control.php" method="get">
			  ...
			  <div class="mb-3 ms-5 me-5">
			    ...
			    <input type="text" class="form-control border border-1 border-primary text-center" placeholder="Заполните фамилию (необязательно)" id="exampleInputPassword1" name="sur" pattern="[A-Za-zА-Яа-яЁё\-']{2,50}">
			  </div>
			  <div class="mb-3 ms-5 me-5">
